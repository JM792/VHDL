...
HD_PWD='E:/TUM/VHDL/Projects/MEMO_extercise/MEMO_extercise.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memory_2_TEST.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memory_2_TEST.tcl
